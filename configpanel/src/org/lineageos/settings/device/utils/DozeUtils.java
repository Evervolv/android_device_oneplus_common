...
public final class DozeUtils {
    ...
    static {
        sPickupSensorMap.put("msm8974", "tilt");
        sPickupSensorMap.put("msm8994", "tilt");
        ...
        sPickupSensorMap.put("msmnile", "oneplus.sensor.op_motion_detect");
        sPickupSensorMap.put("lito", "oneplus.sensor.op_motion_detect");
        sPickupSensorMap.put("kona", "oneplus.sensor.op_motion_detect");

        sPocketSensorMap.put("msm8974", "proximity");
        sPocketSensorMap.put("msm8994", "proximity");
        ...
        sPocketSensorMap.put("msmnile", null);
        sPocketSensorMap.put("lito", "oneplus.sensor.pocket");
        sPocketSensorMap.put("kona", "oneplus.sensor.pocket");
    }
